...
// Windows version - simplified without OSG dependencies for now
// Uses software rendering only

#include <chrono>
#include <cstdint>

// Forward declarations - OSG types not used on Windows for software rendering
namespace osg {
    class Node;
}
